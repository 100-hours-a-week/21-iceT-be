    ...
    public SecurityFilterChain filterChain(HttpSecurity http,
        ...
        http
            ...
            .authorizeHttpRequests(auth -> auth
                .requestMatchers("/api/backend/v1/auth/**","/api/backend/v1/solution", "/swagger-ui/**", "/v3/api-docs/**", "/swagger-resources/**", "/webjars/**", "/actuator/**", "/api/backend/admin/today/problem-set", "/api/backend/test/timezone", "/api/backend/v2/chat/**", "/api/backend/v1/problems/previous")
                .permitAll()
